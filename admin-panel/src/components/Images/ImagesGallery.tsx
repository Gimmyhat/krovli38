    ...
    <Box pos="relative">
      ...
      <Box mb="md">
        <Group justify="apart">
          ...
          <Button variant="outline" leftSection={<IconRefresh size={16} />} onClick={fetchImagesList}>
            Обновить
          </Button>
        </Group>
        ...
        <>
          <Grid>
            {paginatedImages.map((image) => (
              <Grid.Col key={image._id} span={{ xs: 12, sm: 6, md: 4, lg: 3 }}>
                <Card shadow="sm" p="xs" radius="md" withBorder>
                  <Card.Section>
                    <Box pos="relative">
                      ...
                      <Group justify="apart" gap={0} style={{ position: 'absolute', top: 5, width: '100%', padding: '0 5px' }}>
                        ...
                        <Menu position="bottom-end" shadow="md">
                          ...
                          <Menu.Dropdown>
                            ...
                            <Menu.Item 
                              leftSection={image.isActive ? <IconEyeOff size={16} /> : <IconEye size={16} />} 
        ...
        {currentImage && (
          <>
            <Grid>
              ...
              <Grid.Col span={6}>
                <Text size="sm" fw={500}>Размер:</Text>
